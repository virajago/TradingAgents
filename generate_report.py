...
<title>{ticker} Research Report — Conviction</title>
...
<div class="report">
  ...
  <header class="report-header">
    <p class="report-brand">Conviction &nbsp;·&nbsp; Research Report</p>
  ...
  <footer class="report-footer">
    <p class="disclaimer">
      ...
      Conviction is not a registered investment adviser.
    </p>
  </footer>
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate an Conviction report")
